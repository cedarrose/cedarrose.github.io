...
export const researchPaperProject: ResearchPaperProject = {
  ...
  description: [
    'I helped to visualize and communicate the design of our wearable capacitive sweat sensor by creating detailed 3D models of the capacitive sweat rate sensor in Fusion 360.',
...
export const memoirProject: AppProject = {
  ...
  description: [
     'Developed an innovative photo library application specifically designed for visually impaired users',
    'Implemented advanced accessibility features and intuitive navigation systems'
  ],
